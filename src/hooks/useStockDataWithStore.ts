...
export const useStockDataWithStore = () => {
  ...
  const fetchStocks = useCallback(
    ...
    [
      stocksData.setStocks,
      stocksData.setStocksLoading,
      stocksData.setStocksError,
    ]
  )
...
export const useStockWithStore = (symbol: string) => {
  ...
  const fetchStock = useCallback(
    ...
    [
      symbol,
      stockCache.setStockInCache,
      stockCache.setIndividualLoading,
      stockCache.setIndividualError,
    ]
  )
...
export const useChartDataWithStore = (symbol: string, period = '1M') => {
  ...
  const fetchChartData = useCallback(
    ...
    [
      symbol,
      period,
      chartCache.setChartDataInCache,
      chartCache.setChartLoading,
      chartCache.setChartError,
    ]
  )
...
export const useStockQuoteWithStore = (symbol: string, refreshInterval = 0) => {
  ...
  const fetchQuote = useCallback(
    ...
    [
      symbol,
      quoteCache.setQuoteInCache,
      quoteCache.setQuoteLoading,
      quoteCache.setQuoteError,
    ]
  )
